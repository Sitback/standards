...
## Table of Contents
  ...
  1. [Project Handover]{#project-handover}
...
## Version Control
  ...
  > The methodology used is the gitflow method of master, develop and feature branches.
  
  > There are at least three main branches: develop (or development), release, and master. 
  > There are also feature branches where new features are developed. 
  
  > Many of these branches are long running. For example, feature branches are sometimes not included in a release. 
  > This results in a long running branch that needs to be maintained to keep it in sync with the latest release. 
  
  <a name="version-control--workflow"></a><a name="3.1"></a>
  - [3.1]{#version-control--workflow} **Workflow**
  ...
  <a name="version-control--separate-changes"></a><a name="3.2"></a>
  - [3.2]{#version-control--separate-changes} **Separate Changes**
  ...
  <a name="version-control--managing-branches"></a><a name="3.3"></a>
  - [3.3]{#version-control--managing-branches} **Managing Branches**
  ...
  <a name="version-control--graduation"></a><a name="3.4"></a>
  - [3.4]{#version-control--graduation} **Graduation**
  ...
  <a name="version-control--merging-upwards"></a><a name="3.5"></a>
  - [3.5]{#version-control--merging-upwards} **Merging Upwards**
  ...
  <a name="version-control--feature-branches"></a><a name="3.6"></a>
  - [3.6]{#version-control--feature-branches} **Feature Branches**
  
  > Any nontrivial feature will require several patches to implement, and may get extra
  > bug-fixes or improvements during its lifetime.
  ...
  <a name="version-control--merge-downstream"></a><a name="3.7"></a>
  - [3.7]{#version-control--merge-downstream} **Merge Downstream**
  ...
  <a name="version-control--deployment-branches"></a><a name="3.8"></a>
  - [3.8]{#version-control--deployment-branches} **Deployment Branches**

  > You will now have many small feature branches, and during internal 
  > testing need to merge and deploy them.

  > The solution, is to merge them into an aggregate branch and then merge 
  > the result into a deployment branch.
  
  <a name="version-control--aggregate-branches"></a><a name="3.9"></a>
  - [3.9]{#version-control--aggregate-branches} **Aggregate Branches**

  > Aggregate branches are used to integrate multiple feature branches and
  > minimise merge conflicts. Aggregate branches are then merged into 
  > throwaway deployment branches.

  <a name="version-control--release"></a><a name="3.10"></a>
  - [3.10]{#version-control--release} **Release**
  ...
  > Merge the aggregate branch into the release branch. 
  > Update version project metadata and changelog information. 
  > Merge the release branch into the master branch.
  > Apply a tag to the tip of master indicating the release version. 
  > Delete the release branch.
  
  <a name="version-control--post-release"></a><a name="3.11"></a>
  - [3.11]{#version-control--post-release} **Post Release**

  > After a release is complete the feature and aggregate branches can be
  > deleted.
